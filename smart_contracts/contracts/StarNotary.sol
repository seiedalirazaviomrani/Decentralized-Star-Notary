...
contract StarNotary is ERC721 { 
    ...
    function tokenIdToStarInfo(uint256 tokenId) public view returns(string, string, string, string) {
        return (tokenIdToStarInfo[tokenId].story, tokenIdToStarInfo[tokenId].ra,
